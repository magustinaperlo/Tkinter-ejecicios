...
spin1=Spinbox(ventana,from_=0,to=100,width=10,textvariable=var1,state="readonly")
spin1.place(x=300,y=70)

spin2=Spinbox(ventana,from_=0,to=100,width=10,textvariable=var2,state="readonly")
...
resultado=StringVar()
n_generado=Label(ventana,textvariable=resultado,width=10,bg="white",state="disabled")
